  ...
  return (
    <div className="min-h-screen bg-slate-50">
      <div className="max-w-7xl mx-auto px-4 py-8">
        ...
        <div className="bg-indigo-800 rounded-xl shadow-lg border border-indigo-200 p-6 mb-8 max-w-4xl mx-auto text-center">
          <h2 className="text-2xl font-bold text-white mb-3">📢 New: Patch Explorer Desktop App</h2>
